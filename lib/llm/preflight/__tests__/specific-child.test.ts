...
const FAMILY_NOUNS = [
  "child", "son", "daughter", "kid", "baby", "toddler", "boy", "girl",
];
const CONDITION_VERBS = [
  "is", "has", "was", "got", "had", "fell", "seems", "needs",
  "feels", "looks",
];
const HEALTH_CONDITIONS = [
  "sick", "a fever", "a temperature of 101", "vomiting",
  "diarrhea", "an allergic reaction", "allergic to peanuts",
  "hurt", "injured", "bleeding", "a bruise on her arm",
  "a rash", "coughing nonstop", "lice", "pink eye",
  "a concussion", "a head bump", "a stomach bug",
  "not feeling well", "really lethargic", "out of it",
  "a cold", "an infection", "conjunctivitis",
  "bitten by another child",
];
const PROPER_NAMES = [
  "Tommy", "Sarah", "Jake", "Emma", "Liam", "Olivia", "Noah",
  "Ava", "Ethan", "Mia", "Aiden", "Sophia", "Lucas", "Isabella",
  "Mason", "Charlotte", "Logan", "Amelia", "James", "Harper",
  "Diego", "Fatima", "Hiroshi", "Priya", "Kwame", "Sienna",
];
const PRONOUNS_SUBJECT = ["He", "She"];
const PRONOUNS_OBJECT = ["him", "her"];
const MEDICATIONS = [
  "Tylenol", "Motrin", "Advil", "ibuprofen", "his inhaler",
  "her EpiPen", "his medication", "her antibiotics",
  "acetaminophen", "his prescription", "allergy medicine",
];
