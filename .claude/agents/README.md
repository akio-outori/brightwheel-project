...
The agents are _part of the deliverable_. An interviewer reading the
...
The reviewers run _after_ the implementation agent reports it's done
...
- [`README.md`](../../README.md) — project overview and one-command
  setup _(written during the polish step)_
- [`WRITEUP.md`](../../WRITEUP.md) — the design pitch _(written
  during the polish step)_
